...
class AppStats extends Model
{
    ...
    */
    ...
    public function scopeLastNDays($query, $value) 
    {
        ...
        return $query->whereBetween('app_day', [$start_date->toDateString(), $end_date->toDateString()]);
    }
    ...
    /**
     * Get the user agents for the stat row.
     */
    public function user_agent()
    {
        return $this->hasOne('App\UserAgents', 'ua_id', 'id');
    }
}
