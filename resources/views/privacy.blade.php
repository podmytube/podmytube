...
<div class="mx-auto">
    ...
    <p>Among the types of Personal Data that this Application collects, by itself or through third parties, there are: Cookies; Usage Data; email address; first name, last name.</p>
    ...
    <p>The Data concerning the User is collected to allow the Owner to provide its Services, as well as for the following purposes: Analytics, Contacting the User, Handling payments, Registration and authentication, Hosting and backend infrastructure and Tag Management.</p>
    ...
    <p>Actually there is no analytics system used to track the user during his/her visit on podmytube website.</p>
    ...
    <p>Personal Data collected: <strong>email address</strong>.</p>

    <h4>Handling payments</h4>

    <p>Payment processing services enable this Application to process payments by credit card, bank transfer or other means. To ensure greater security, this Application shares only the information necessary to execute the transaction with the financial intermediaries handling the transaction.</p>
    <p>Some of these services may also enable the sending of timed messages to the User, such as emails containing invoices or notifications concerning the payment.</p>

    <h5>Stripe (Stripe Inc)</h5>
    ...
    <p>Place of processing: United States – <a href="https://stripe.com/terms/US" target="_blank">Privacy Policy</a>. Privacy Shield participant.</p>

    <h4>Hosting and backend infrastructure</h4>

    <pThis type of service has the purpose of hosting Data and files that enable this Application to run and be distributed as well as to provide a ready-made infrastructure to run specific features or parts of this Application. Some of these services work through geographically distributed servers, making it difficult to determine the actual location where the Personal Data are stored.</p> <h5>OVH</h5>

        <p>OVH is a hosting and backend service provided by OVH.</p>

        <p>Personal Data collected: various types of Data as specified in the privacy policy of the service.</p>

        <p>Place of processing: France – <a href="https://www.ovh.com/fr/protection-donnees-personnelles/" target="_blank">Privacy Policy (French speaking)</a>. Privacy Shield participant.</p>
        ...
        <p>The Personal Data collected to complete the payment may include the credit card, the bank account used for the transfer, or any other means of payment envisaged. The kind of Data collected by this Application depends on the payment system used.</p>
