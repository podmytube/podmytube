            ...
            <div class="bg-white shadow-md rounded px-8 pt-2 py-4 mb-3 flex flex-col">
                <div class="mx-auto">
                    <svg class="h-24 w-auto inline fill-current" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="m80.5 70.6a1.8 1.8 0 0 0 2.4-0.4 23.5 23.5 0 1 0-37.9 0 1.8 1.8 0 1 0 2.8-2.1 20 20 0 1 1 32.2 0 1.8 1.8 0 0 0 0.4 2.4z" />
                        <path
                            d="m44.4 83.8a1.8 1.8 0 0 0 2-2.8 30.3 30.3 0 1 1 35.1 0 1.8 1.8 0 0 0 2 2.9 33.8 33.8 0 1 0-39.2 0z" />
                        <path
                ...
                <div class="flex items-center justify-between">
                    ...
                    <ul class="inline-block">
                        ...
                        <li>
                            <a href="{{ route('password.request', ['email' => old('email')]) }}"
                                class="inline-block align-baseline font-bold text-sm text-blue hover:text-blue-darker">
                                Forgot Password? </a>
                        </li>
                    </ul>
