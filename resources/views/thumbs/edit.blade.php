        ...
        <div class="bg-gray-100 mt-6 px-4 py-4 rounded-lg">
            <form class="max-w-5xl" id="edit-cover-form" method="POST" enctype="multipart/form-data"
                ...
                <div class="p-6 flex justify-center items-center">
                    <a href="#"
                        onclick="event.preventDefault(); document.getElementById('edit-cover-form').submit();">
                        <button type="button" id="btnSubmit"
                            class="flex-1 bg-gray-800 hover:bg-gray-700 text-gray-100 font-bold py-2 px-4 rounded-l-lg">Update</button>
                    </a>
                    <a href="{{ route('home') }}">
                        <button type="button"
