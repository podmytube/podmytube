    ...
    <section class="my-header">
        <main role="main">
            <div class="container header-textpart">
                ...
                <div>
                    <a class="btn btn-lg btn-success mt-5 text-uppercase" href="https://dashboard.podmytube.com/register" role="button">Get started free</a>
...
<section id="features" class="container features">
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-lg-4 featbox">
                <i class="fas fa-chart-line fa-3x rougepod" aria-hidden="true"></i>
            ...
            <div class="col-xs-12 col-sm-6 col-lg-4 featbox">
                <i class="fas fa-dollar-sign fa-3x rougepod" aria-hidden="true"></i>
            ...
            <div class="col-xs-12 col-sm-6 col-lg-4 featbox">
                <i class="fas fa-heart fa-3x rougepod" aria-hidden="true"></i>
            ...
            <div class="col-xs-12 col-sm-6 col-lg-4 featbox">
                <i class="fas fa-comment fa-3x rougepod" aria-hidden="true"></i>
            ...
            <div class="col-xs-12 col-sm-6 col-lg-4 featbox">
                <i class="fas fa-cogs fa-3x rougepod" aria-hidden="true"></i>
            ...
            <div class="col-xs-12 col-sm-6 col-lg-4 featbox">
                <i class="fas fa-gift fa-3x rougepod" aria-hidden="true"></i>
            ...
            <div class="col-xs-12 col-sm-6 col-lg-4 featbox">
                <i class="fas fa-filter fa-3x rougepod" aria-hidden="true"></i>
            ...
            <div class="col-xs-12 col-sm-6 col-lg-4 featbox">
                <i class="fab fa-youtube fa-3x rougepod" aria-hidden="true"></i>
            ...
            <div class="col-xs-12 col-sm-6 col-lg-4 featbox">
                <i class="fas fa-hdd fa-3x rougepod" aria-hidden="true"></i>
                <h3>Hosted.</h3>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-lg-4 featbox">
                <i class="fas fa-smile fa-3x rougepod" aria-hidden="true"></i>
                <h3>Happy customers</h3>
                <p>{{ \App\User::all()->count() }}</p>
            </div>
            <div class="col-xs-12 col-sm-6 col-lg-4 featbox">
                <i class="fas fa-file-audio fa-3x rougepod" aria-hidden="true"></i>
            ...
            <div class="col-xs-12 col-sm-6 col-lg-4 featbox">
                <i class="fas fa-cloud-download-alt fa-3x rougepod" aria-hidden="true"></i>
                <h3>Downloads/Day</h3>
    ...
    <div class="container py-3 text-center">
        ...
        <div class="card-deck mb-3 text-center plan-cards">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header rougepodbg text-white">
                    <h3 class="my-0 font-weight-normal">
                        {!! __('pricing.'.$plan['name']) !!}
                    </h3>
                </div>
                <div class="card-body">
                    <h3 class="card-title pricing-card-title">
                        {!! __('pricing.price_monthly', ['price' =>
                        $plan['price']]) !!}
                    </h3>
                    <ul class="list-unstyled my-1">
                        {!! __('pricing.episodes_per_month', ['nb' =>
                        $plan['nb_episodes_per_month']]) !!} @if ($plan['price']
                        > 0) {!! __('pricing.standard_paying_features') !!}
                        @else {!! __('pricing.free_retention_period') !!} @endif
                    </ul>
                </div>
            </div>
            @endforeach
        ...
        <a class="btn btn-lg btn-success mt-5 text-uppercase" href="https://dashboard.podmytube.com/register">Get started free</a>
        <p class="text-muted">no credit card, cancel anytime</p>
    </div>
</section>
...
<section class="post_footer">
    <div class="container text-center">
        <ul class="list-inline">
            <li class="list-inline-item"><a href="https://twitter.com/podmytube" class="nav-link" target="tab"> <i class="fab fa-twitter fa-2x rougepod"></i> </a></li>
            <li class="list-inline-item"><a href="https://www.facebook.com/Podmytube" class="nav-link" target="tab"> <i class="fab fa-facebook fa-2x rougepod"></i> </a></li>
        </ul>
    </div>
</section>
@endsection