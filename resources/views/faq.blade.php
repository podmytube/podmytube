        ...
        <div class="flex flex-col">
            ...
            <div class="py-4">
                ...
                <p class="text-gray-700 text-base">
                    ...
                    <ol class="text-gray-700 list-decimal pl-8 text-base">
                        ...
                        <li>Validate it. Apple is doing a manual validation on your feed. Usually, it takes between 24/48 hours.</li>
                    </ol>
                </p>
            </div>
            ...
            <div class="py-4">
                ...
                <p class="text-gray-700 py-2 text-base"> 
                    ...
                    Then, the easiest way to listen to it is to copy this feed url and paste it into your favorite podcast app.<br>
            ...
            <div class="py-4">
                ...
                <ul class="text-gray-700 list-disc pl-8 text-base">
                    <li>Free plan start with the last episode published on Youtube and paid plans are including various number of episode according to the plan itself.</li>
                ...
                <p class="text-gray-700 py-2 text-base"> 
                    If it's not enough and you absolutely want me to include all your episodes from the birth of your channel, please <a href="mailto:contact@podmytube.com" class="underline">contact me</a>.
                </p>
            </div>
            ...
            <div class="py-4">
                ...
                <ol class="text-gray-700 list-decimal pl-8 text-base">
                    ...
                    <li>Once done for all the video you want to include, go back to the <a href="{{ route('home')}}" class="underline">dashboard</a></li>
                    <li>Edit your channel</li>
                    <li>Fill the blank with the same tag in the sentence "I only want to include videos with the [....] tag". Save and its done</li>
                </ol>
            </div>
