<!-- upgrade needed - quota exhausted, you need to upgrade -->
<svg class="{{ $cssClass }}" version="1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" enable-background="new 0 0 48 48">
    <title>{{ $comment }}</title>
