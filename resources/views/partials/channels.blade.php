...
@if (count($channels))
    ...
    @foreach ($channels as $channel)
        <div class="mx-auto md:mx-0 lg:flex-1 max-w-md rounded-lg shadow-lg bg-gray-100 text-gray-900 pt-4 md:pt-10 pb-4 mb-4 lg:mb-0">
            <img class="mx-auto shadow rounded-lg" src="{{$channel->vigUrl}}" alt="Cover for {{ $channel->title() }}" role="img">
            ...
            <p class="text-center pb-6">
                <a href="{{ route('plans.index', $channel) }}">
                    <button target="_blank" class="bg-green-800 hover:bg-purple-800 text-white font-bold py-2 px-4 rounded-lg">
                        <svg class="h-6 w-auto inline fill-current" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 382.7 382.7">
                            <title>A rocket ready to be launched.</title>
            ...
            <div class="text-center pb-6">
                <a href="{{ $channel->podcastUrl() }}" target="_blank">
                    <button class="bg-purple-800 hover:bg-purple-900 text-gray-100 font-bold py-2 px-4 rounded-lg">
                        <svg class="h-6 w-auto inline fill-current" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <title>The podcast logo.</title>
            ...
            <div class="px-4">
                <div class="flex justify-center items-center">
                    <a href="{{ route('channel.edit', $channel) }}" title="Edit your podcast informations.">
                        <button class="flex-1 bg-gray-200 shadow hover:bg-gray-400 text-gray-800 font-bold py-2 px-2 rounded-l-lg">
                            <svg class="h-6 w-auto inline fill-current" role="img" viewBox="0 -1 401.52289 401" xmlns="http://www.w3.org/2000/svg">
                                <title>Edit your podcast informations.</title>
                    ...
                    <a href="{{ route('channel.thumbs.edit', $channel) }}" title="Upload a new cover for your podcast.">
                        <button class="flex-1 bg-gray-200 shadow hover:bg-gray-400 text-gray-800 font-bold py-2 px-2"> 
                            <svg class="h-6 w-auto inline fill-current" role="img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 419.2 419.2" xml:space="preserve">
                                <title>Upload a new cover for your podcast.</title>
                                <g>
                    ...
                    <a href="{{ route('channel.medias.index', $channel) }}" title="All your podcast episodes.">
                        <button class="flex-1 bg-gray-200 shadow hover:bg-gray-400 text-gray-800 font-bold py-2 px-2 rounded-r-lg">
                            <svg class="h-6 w-auto inline fill-current" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 480 480" xml:space="preserve">
                                <title>All your podcast episodes.</title>
                                <g>
