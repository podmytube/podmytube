<header class="text-gray-100 sm:flex sm:justify-between sm:py-2 sm:px-4 max-w-screen-xl mx-auto">
    ...
    <div class="hidden pt-2 pb-4 text-center sm:flex sm:items-center sm:p-0" id="mobile-nav">
        @guest
            <a class="     block px-4 py-2 text-gray-100 rounded hover:bg-gray-800" href="{{ route('pricing') }}"> Pricing
            </a>
            ...
            <a class="mt-1 block px-4 py-2 text-gray-100 rounded hover:bg-gray-800 sm:mt-0 sm:mr-2 sm:hover:bg-white sm:border sm:rounded sm:border-white hover:border-transparent hover:text-gray-900"
                href="{{ route('register') }}"> Sign Up </a>
        @else
            <a class="     block px-4 py-2 text-gray-100 rounded hover:bg-gray-800" href="{{ route('home') }}"> Dashboard
            </a>
            <a class="mt-1 block px-4 py-2 text-gray-100 rounded hover:bg-gray-800 sm:mt-0 sm:mr-2"
