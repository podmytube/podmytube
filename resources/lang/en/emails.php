...
return [
    ...
    'welcome_p_register' => 'Now that you are registered, you should add the youtube channel you want to convert, in a magnificent podcast',
    'welcome_a_add_one_channel' => 'Convert my channel',

    'registered_h1_success' => 'Congratulations :name,',
    'registered_p_channel_is_now_registered' => "Channel <b>:channel_id</b> is now registered.",
    'registered_p_in_a_few_minutes' => "In a few minutes, you channel will be validated then your podcast will include your last episodes.",
    ...
    'registered_p_if_you_have_any_questions' => "If you have any question, you only have to ask, I'm here to help :).<br>Cheers.<br>Fred",
