...
INSERT INTO channels (channel_id, user_id, channel_name, channel_premium, active, category_id, accept_video_by_tag) VALUES
    ('freeChannel', 1, 'Free users', 0, 1, 1, null),
    ('earlyChannel', 1, 'Early birds', 1, 1, 21, null),
    ('weeklyChannel', 1, 'Weekly youtuber', 2, 1, 32, null),
    ('dailyChannel', 1, 'Daily youtuber', 3, 1, 43, null),
    ('UCq80IvL314jsE7PgYsTdw7Q', 2, 'Accropolis', 3, 1, 54, null),
    ('UCnF1gaTK11ax2pWCIdUp8-w', 2, 'Monthly subscribers 6€/month - delphine dimanche', 3, 1, 65, null),
    ('UCnf8HI3gUteF1BKAvrDO9dQ', 2, 'Yearly subscribers 66€/year - alex borto', 3, 1, 76, null),
    ('invalidChannel', 2, 'Invalid channel', 0, 1, 87, null);
...
INSERT INTO medias (media_id, channel_id, title, published_at, grabbed_at) VALUES
("FYJ3NUWoOvE", "weeklyChannel", "This video is eligible", DATE_FORMAT(NOW() ,'%Y-%m-28'), NULL),
("zmfOeATX4fY", "weeklyChannel", "This video is eligible", DATE_FORMAT(NOW() ,'%Y-%m-20'), NULL),
("iuXckmWv4Pc", "weeklyChannel", "This video is eligible", DATE_FORMAT(NOW() ,'%Y-%m-15'), NULL),
("qSs5zsGoqs4", "weeklyChannel", "This video is eligible", DATE_FORMAT(NOW() ,'%Y-%m-10'), NULL),
("y3GLhAumiec", "weeklyChannel", "This video is eligible", DATE_FORMAT(NOW() ,'%Y-%m-05'), NULL),
("o308rJlWKUc", "weeklyChannel", "This video is eligible", DATE_FORMAT(NOW() ,'%Y-%m-01'), NULL),
("-wvQP07Syak", "weeklyChannel", "This video is NOT eligible - too long ago", '2019-04-03', NULL),
("8ZwgoVmILQU", "weeklyChannel", "This video is NOT eligible - too long ago", '2019-04-06', NULL);
