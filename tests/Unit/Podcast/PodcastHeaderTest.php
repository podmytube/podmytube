...
class PodcastHeaderTest extends TestCase
{
    ...
    {
        $renderedResult = ($podcastHeaderObj = PodcastHeader::generateFor($this->channel))->render();
        ...
        $this->assertStringContainsString("<language>" . $this->channel->lang . "</language>", $renderedResult);
         ...
         */
        $this->assertStringContainsString("<itunes:author>" . $this->channel->authors . "</itunes:author>", $renderedResult);
        $this->assertStringContainsString("<itunes:title>" . $this->channel->title() . "</itunes:title>", $renderedResult);
        $this->assertStringContainsString("<itunes:owner>", $renderedResult);
        $this->assertStringContainsString("<itunes:name>" . $this->channel->authors . "</itunes:name>", $renderedResult);
        $this->assertStringContainsString("<itunes:email>" . $this->channel->email . "</itunes:email>", $renderedResult);
        $this->assertStringContainsString("</itunes:owner>", $renderedResult);
        $this->assertStringContainsString("<itunes:explicit>", $renderedResult);
        $this->assertStringContainsString("<itunes:category text=\"" . $this->channel->category->categoryFeedValue() . "\" />", $renderedResult);
    ...
    public function testingHeaderRenderingShouldBeFine()
    {
        ...
        $this->assertStringContainsString("<image>", $renderedResult);
        $this->assertStringContainsString("<url>" . $this->channel->thumb->podcastUrl() . "</url>", $renderedResult);
        $this->assertStringContainsString("<title>" . $this->channel->title() . "</title>", $renderedResult);
        $this->assertStringContainsString("<link>" . $this->channel->link . "</link>", $renderedResult);
        $this->assertStringContainsString("</image>", $renderedResult);
        ...
        $this->assertStringContainsString("<itunes:explicit>", $renderedResult);
        $this->assertStringContainsString("<itunes:category text=\"" . $this->channel->category->categoryFeedValue() . "\" />", $renderedResult);
        $this->assertStringContainsString('<itunes:image href="' . $this->channel->thumb->podcastUrl() . '" />', $renderedResult);
    }
}
